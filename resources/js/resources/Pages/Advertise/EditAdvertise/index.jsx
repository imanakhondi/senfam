...
import { editAdvertisePage, validation } from "../../../constants/strings/fa";
...
const EditAdvertise = () => {
    ...
    const onSubmit = async (values) => {
        ...
        // }
        // setLoading(false);
        // toast.success(`${editAdvertisePage.submitted}`);
    ...
    return (
        <FormikForm
            ...
            loading={loading}
            error={messageState}
            title={`${editAdvertisePage._title}`}
            subTitle={`${editAdvertisePage._subTitle}`}
        >
            <FormikControl
                control="input"
                name="name"
                formik={formik}
                pageString={editAdvertisePage}
            />
            <FormikControl
                control="input"
                name="family"
